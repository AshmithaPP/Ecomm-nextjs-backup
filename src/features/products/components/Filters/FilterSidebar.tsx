...
const FilterSidebar = () => {
    ...
    // Calculate count of active filters (excluding internal pagination and sorting params)
    ...
    return (
        <>
            {/* 1. Mobile Bottom Action Bar (Sticky) */}
            ...
            {/* 2. Mobile Full-Screen Filter Drawer/Modal */}
            {isMobileModalOpen && (
                <div className="mobile-filter-modal">
                    ...
                    <div className="mobile-filter-modal-footer" style={{ position: 'absolute', bottom: 0, left: 0, right: 0, zIndex: 10 }}>
                        <button className="mobile-cta-btn" onClick={() => setIsMobileModalOpen(false)}>
                            See {pagination.total_products || products.length} products
                        </button>
                    </div>
                </div>
            )}

            {/* 3. Original Desktop Sidebar */}
